...
public abstract class Settings {
	public static final String version = "2.0.7.1";
	...
	public static double frameTime = 1.0D/60; //a number 1D/60 will make the frameRate around 60 fps (first number MUST be a decimal) unless the engine isn't fast enough to keep up
