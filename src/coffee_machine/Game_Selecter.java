...
import danceDanceRevolution.DDRRunner;
...
public class Game_Selecter {
	public static void main(String[] args) {
		...
		String[] gameOptions = new String[] {"Jetpack Joyride","3D Pong","Legend of Java 1", "Legend of Java 2", "Dance Dance Revolution","Essay Writer", "Exit"};
		...
		while(! exit) {
			...
			if (gameOptions[gameSelection].equals("Jetpack Joyride")) {
				...
				new LegendOfJava2();
			}else if (gameOptions[gameSelection].equals("Dance Dance Revolution")) {
				new DDRRunner();
